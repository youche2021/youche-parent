...
public class ResultUtils implements Serializable {
    ...
    public static <T> ResponseEntity<Result<T>> message(boolean success) {
        return success ? ok() : error();
    }

    public static <T> ResponseEntity<Result<T>> message(boolean success, String message) {
        return success ? ok(message) : error(message);
    }

    public static <T> ResponseEntity<Result<T>> message(boolean success, T data) {
        return success ? ok(data) : error(data);
    }

    public static <T> ResponseEntity<Result<T>> message(boolean success, T data, String message) {
        return success ? ok(data, message) : error(data, message);
    }
}
